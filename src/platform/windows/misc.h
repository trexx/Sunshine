...
namespace platf {
  ...
  // Process helpers shared with the HIDMaestro broker launcher. Documented (Doxygen) at
  // their definitions in misc.cpp; plain comments here avoid duplicate parameter docs.
